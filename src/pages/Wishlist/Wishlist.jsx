    ...
    return (
        ...
        <main className="wishlist-container">
                <div className="listing-header">
                    <div className="listing-heading">Wishlist</div>
                ...
                <div className="wishlist-items">
                    <div className="card-listing-container">
                        ...
                        <div className="card-container">
                            ...
                            <div className="wishlist"><i className="fas fa-heart"></i></div>

                            <div className="delete"><i className="far fa-times-circle"></i></div>
                        ...
                        <div className="card-container">
                            ...
                            <div className="add-to-cart">
                                ...
                                <button className="card-button remove"><i className="fas fa-shopping-bag"></i>Remove</button>
                            </div>
                        </div>
